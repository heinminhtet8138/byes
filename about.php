    ...
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <h1 class="display-4 fw-bold mb-4">Empowering Voices Through <span class="text-primary">English</span></h1>
...
<section class="py-5">
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-md-6">
                <div class="p-5 bg-white border rounded-4 h-100">
                    <div class="mb-4">
                        <i class="bi bi-rocket-takeoff fs-1 text-primary"></i>
                    </div>
                    <h2 class="fw-bold mb-3">Our Mission</h2>
                    <p class="text-muted lead">To provide high-quality, accessible English language education that equips students with the practical skills needed for global communication and career advancement.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="p-5 bg-white border rounded-4 h-100">
                    ...
                    <p class="text-muted lead">To be the leading language school recognized for innovative teaching methods and a commitment to student success in a connected world.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm rounded-4 text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        ...
                        <a href="#" class="btn btn-sm btn-outline-secondary rounded-circle"><i class="bi bi-twitter"></i></a>
                    </div>
                </div>
            </div>
            <!-- Instructor 2 -->
